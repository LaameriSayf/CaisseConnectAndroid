...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        clientApi = RetrofitClientsaif.getInstance().create(ClientApi.class);
    ...
    private void handleSubmit() {
        ...
        Client client = new Client(Math.toIntExact(clientIdToEdit), name, prenom, phone, rib);
    ...
    private void updateClient(Client client) {
        clientApi.updateClient(Math.toIntExact(client.getIdClient()), client).enqueue(new Callback<Client>() {
            @Override
